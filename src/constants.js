...
export const C = {
  ...
  shadowLg:    "0 8px 24px rgba(0,0,0,.10)",
};
...
export const STATUS = {
  pending:       { label: "Pendiente",   color: "#9CA3AF", bg: "#F9FAFB",  dot: "#D1D5DB" },
  today:         { label: "Para hoy",    color: "#1D4ED8", bg: "#EFF6FF",  dot: "#1D4ED8" },
  "in-progress": { label: "En curso",   color: "#D97706", bg: "#FFFBEB",  dot: "#D97706" },
  done:          { label: "Completado", color: "#059669", bg: "#ECFDF5",  dot: "#059669" },
  issue:         { label: "Incidencia", color: "#DC2626", bg: "#FEF2F2",  dot: "#DC2626" },
  skipped:       { label: "Omitido",    color: "#7C3AED", bg: "#F5F3FF",  dot: "#7C3AED" },
};
...
export const minAgo   = t => { if(!t)return 0;const[h,m]=t.split(":").map(Number),now=new Date(),then=new Date();then.setHours(h,m,0,0);return Math.floor((now-then)/60000); };
